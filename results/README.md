...
| `SRL-2018-RD01_session_tokens.json` | BASE-RD-01 live re-ingest (workstation) | 2026-06-12 |
...
all five runs = 0.0% hallucination rate.
...
| `SRL-2018-RD01_audit_sample.jsonl` | 14-claim audit sample from live RD-01 re-ingest (2026-06-12) |
